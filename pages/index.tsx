...
const Home = ({data, loggedIn, changeTheme, currentTheme }: { data?: UserData, loggedIn: boolean, changeTheme: any, currentTheme: CurrentTheme}) => {
  return (
    <>
      <Head>
      ...
      <Header loggedIn={loggedIn} where='home' changeTheme={changeTheme} currentTheme={currentTheme}>Dashboard</Header>
